...
TEST_F(TestsCapabilitiesGenerated, TestCooperativeMatrixPropertiesNV) {
    ...
    EXPECT_EQ(cooperative_matrix_properties_profile.cooperativeMatrixSupportedStages, VK_SHADER_STAGE_MISS_BIT_KHR);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestSubgroupSizeControlPropertiesEXT) {
    ...
    EXPECT_EQ(subgroup_size_control_properties_profile.requiredSubgroupSizeStages, VK_SHADER_STAGE_ANY_HIT_BIT_NV);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestClusterCullingShaderPropertiesHUAWEI) {
#ifdef VK_HUAWEI_cluster_culling_shader
    bool supported = false;
    supported = supported && IsSupported(gpu_profile, "VK_HUAWEI_cluster_culling_shader");

    VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI cluster_culling_shader_properties_native{};
    cluster_culling_shader_properties_native.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_CULLING_SHADER_PROPERTIES_HUAWEI;

    VkPhysicalDeviceProperties2 gpu_props_native{};
    gpu_props_native.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2;
    gpu_props_native.pNext = &cluster_culling_shader_properties_native;
    vkGetPhysicalDeviceProperties2(gpu_native, &gpu_props_native);

    VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI cluster_culling_shader_properties_profile{};
    cluster_culling_shader_properties_profile.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_CULLING_SHADER_PROPERTIES_HUAWEI;

    VkPhysicalDeviceProperties2 gpu_props_profile{};
    gpu_props_profile.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2;
    gpu_props_profile.pNext = &cluster_culling_shader_properties_profile;
    vkGetPhysicalDeviceProperties2(gpu_profile, &gpu_props_profile);

    EXPECT_EQ(cluster_culling_shader_properties_profile.maxWorkGroupCount[0], 177);
    EXPECT_EQ(cluster_culling_shader_properties_profile.maxWorkGroupCount[1], 177);
    EXPECT_EQ(cluster_culling_shader_properties_profile.maxWorkGroupCount[2], 177);
    EXPECT_EQ(cluster_culling_shader_properties_profile.maxWorkGroupSize[0], 178);
    EXPECT_EQ(cluster_culling_shader_properties_profile.maxWorkGroupSize[1], 178);
    EXPECT_EQ(cluster_culling_shader_properties_profile.maxWorkGroupSize[2], 178);
    EXPECT_EQ(cluster_culling_shader_properties_profile.maxOutputClusterCount, 179);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestLineRasterizationPropertiesEXT) {
    ...
    EXPECT_EQ(line_rasterization_properties_profile.lineSubPixelPrecisionBits, 180);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestCustomBorderColorPropertiesEXT) {
    ...
    EXPECT_EQ(custom_border_color_properties_profile.maxCustomBorderColorSamplers, 181);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestRobustness2PropertiesEXT) {
    ...
    EXPECT_EQ(robustness_2_properties_profile.robustStorageBufferAccessSizeAlignment, 182);
    EXPECT_EQ(robustness_2_properties_profile.robustUniformBufferAccessSizeAlignment, 183);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestPortabilitySubsetPropertiesKHR) {
    ...
    EXPECT_EQ(portability_subset_properties_profile.minVertexInputBindingStrideAlignment, 184);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestFragmentShadingRatePropertiesKHR) {
    ...
    EXPECT_EQ(fragment_shading_rate_properties_profile.minFragmentShadingRateAttachmentTexelSize.width, 185);
    EXPECT_EQ(fragment_shading_rate_properties_profile.minFragmentShadingRateAttachmentTexelSize.height, 186);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentShadingRateAttachmentTexelSize.width, 187);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentShadingRateAttachmentTexelSize.height, 188);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentShadingRateAttachmentTexelSizeAspectRatio, 189);
    ...
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentSize.width, 190);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentSize.height, 191);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentSizeAspectRatio, 192);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentShadingRateCoverageSamples, 193);
    EXPECT_EQ(fragment_shading_rate_properties_profile.maxFragmentShadingRateRasterizationSamples, VK_SAMPLE_COUNT_32_BIT);
...
TEST_F(TestsCapabilitiesGenerated, TestFragmentShadingRateEnumsPropertiesNV) {
    ...
    EXPECT_EQ(fragment_shading_rate_enums_properties_profile.maxFragmentShadingRateInvocationCount, VK_SAMPLE_COUNT_64_BIT);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestDescriptorBufferPropertiesEXT) {
    ...
    EXPECT_EQ(descriptor_buffer_properties_profile.maxDescriptorBufferBindings, 197);
    EXPECT_EQ(descriptor_buffer_properties_profile.maxResourceDescriptorBufferBindings, 198);
    EXPECT_EQ(descriptor_buffer_properties_profile.maxSamplerDescriptorBufferBindings, 199);
    EXPECT_EQ(descriptor_buffer_properties_profile.maxEmbeddedImmutableSamplerBindings, 200);
    EXPECT_EQ(descriptor_buffer_properties_profile.maxEmbeddedImmutableSamplers, 201);
    if (supported) {
    ...
    EXPECT_EQ(descriptor_buffer_properties_profile.samplerDescriptorSize, 207);
    EXPECT_EQ(descriptor_buffer_properties_profile.combinedImageSamplerDescriptorSize, 208);
    EXPECT_EQ(descriptor_buffer_properties_profile.sampledImageDescriptorSize, 209);
    EXPECT_EQ(descriptor_buffer_properties_profile.storageImageDescriptorSize, 210);
    EXPECT_EQ(descriptor_buffer_properties_profile.uniformTexelBufferDescriptorSize, 211);
    EXPECT_EQ(descriptor_buffer_properties_profile.robustUniformTexelBufferDescriptorSize, 212);
    EXPECT_EQ(descriptor_buffer_properties_profile.storageTexelBufferDescriptorSize, 213);
    EXPECT_EQ(descriptor_buffer_properties_profile.robustStorageTexelBufferDescriptorSize, 214);
    EXPECT_EQ(descriptor_buffer_properties_profile.uniformBufferDescriptorSize, 215);
    EXPECT_EQ(descriptor_buffer_properties_profile.robustUniformBufferDescriptorSize, 216);
    EXPECT_EQ(descriptor_buffer_properties_profile.storageBufferDescriptorSize, 217);
    EXPECT_EQ(descriptor_buffer_properties_profile.robustStorageBufferDescriptorSize, 218);
    EXPECT_EQ(descriptor_buffer_properties_profile.inputAttachmentDescriptorSize, 219);
    EXPECT_EQ(descriptor_buffer_properties_profile.accelerationStructureDescriptorSize, 220);
    EXPECT_EQ(descriptor_buffer_properties_profile.maxSamplerDescriptorBufferRange, 221);
    EXPECT_EQ(descriptor_buffer_properties_profile.maxResourceDescriptorBufferRange, 222);
    EXPECT_EQ(descriptor_buffer_properties_profile.samplerDescriptorBufferAddressSpaceSize, 223);
    EXPECT_EQ(descriptor_buffer_properties_profile.resourceDescriptorBufferAddressSpaceSize, 224);
    EXPECT_EQ(descriptor_buffer_properties_profile.descriptorBufferAddressSpaceSize, 225);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestDescriptorBufferDensityMapPropertiesEXT) {
    ...
    EXPECT_EQ(descriptor_buffer_density_map_properties_profile.combinedImageSamplerDensityMapDescriptorSize, 226);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestOpacityMicromapPropertiesEXT) {
    ...
    EXPECT_EQ(opacity_micromap_properties_profile.maxOpacity2StateSubdivisionLevel, 232);
    EXPECT_EQ(opacity_micromap_properties_profile.maxOpacity4StateSubdivisionLevel, 233);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestImageProcessingPropertiesQCOM) {
    ...
    EXPECT_EQ(image_processing_properties_profile.maxWeightFilterPhases, 238);
    EXPECT_EQ(image_processing_properties_profile.maxWeightFilterDimension.width, 239);
    EXPECT_EQ(image_processing_properties_profile.maxWeightFilterDimension.height, 240);
    EXPECT_EQ(image_processing_properties_profile.maxBlockMatchRegion.width, 241);
    EXPECT_EQ(image_processing_properties_profile.maxBlockMatchRegion.height, 242);
    EXPECT_EQ(image_processing_properties_profile.maxBoxFilterBlockSize.width, 243);
    EXPECT_EQ(image_processing_properties_profile.maxBoxFilterBlockSize.height, 244);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestOpticalFlowPropertiesNV) {
    ...
    EXPECT_EQ(optical_flow_properties_profile.supportedOutputGridSizes, VK_OPTICAL_FLOW_GRID_SIZE_UNKNOWN_NV);
    EXPECT_EQ(optical_flow_properties_profile.supportedHintGridSizes, VK_OPTICAL_FLOW_GRID_SIZE_1X1_BIT_NV);
    if (supported) {
...
TEST_F(TestsCapabilitiesGenerated, TestShaderCoreBuiltinsPropertiesARM) {
    ...
    EXPECT_EQ(shader_core_builtins_properties_profile.shaderCoreMask, 252);
    EXPECT_EQ(shader_core_builtins_properties_profile.shaderCoreCount, 253);
    EXPECT_EQ(shader_core_builtins_properties_profile.shaderWarpsPerCore, 254);
#endif
}
...
TEST_F(TestsCapabilitiesGenerated, TestRayTracingInvocationReorderPropertiesNV) {
    ...
    if (supported) {
    EXPECT_EQ(ray_tracing_invocation_reorder_properties_profile.rayTracingInvocationReorderReorderingHint, ray_tracing_invocation_reorder_properties_native.rayTracingInvocationReorderReorderingHint);
    }
...
TEST_F(TestsCapabilitiesGenerated, Test_FORMAT_R16G16_S10_5_NV) {
    ...
    VkFormatFeatureFlags linear_tiling_features = VK_FORMAT_FEATURE_DISJOINT_BIT | VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT | VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT;
    VkFormatFeatureFlags optimal_tiling_features = VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR | VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT;
    VkFormatFeatureFlags buffer_features = VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT | VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR | VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR;
    EXPECT_EQ(format_properties.linearTilingFeatures & linear_tiling_features, linear_tiling_features);
    EXPECT_EQ(format_properties.optimalTilingFeatures & optimal_tiling_features, optimal_tiling_features);
    EXPECT_EQ(format_properties.bufferFeatures & buffer_features, buffer_features);
}
