...
void TextureBuilder::createtexture2(const std::string& texturepath) {

// 	BufferBuilder buffer;

// 	int texWidth, texHeight, texChannels;
//    // stbi_uc* pixels = stbi_load("./texture/cube.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
//     VkDeviceSize imagesize = bg_jpg_len ;
...
//         memcpy(datadst, &bg_jpg[0], (size_t)imagesize);
